...
// Outer and inner circles, converted to polygons.
const outerC2 = new Rune.Circle(0, 0, outerR).toPolygon({ spacing: 10 }, city).fill("none")
...
for (let i = 0; i < gates; i++) {
    ...
    // Check if even or odd, then draw the appropriate bits. If even:
    if (i % 2 == 0) {
        ...
        // Put the word "Porta" in, rotated after half way round
        if (i >= gates / 2) {
        ...
        // Draw a rectangle to mark the gate
